...
- `en/index.html` が日本語トップとずれている。「めざすこと」の節がない。事業の柱が日本語の4本（アプリ、日常を書く、店舗へのAI導入、導入支援）ではなく、古い3枚のまま。事業概要の What we do に店舗へのAI導入がない。名所カードがまだ攻略の文章を載せたままで、英語の攻略ページ（日本語の `spots/` に当たるもの）がない。
